...
namespace App\Livewire\Admin\WeddingManagement;
 ...
 public function create()
{
    ...
    \App\Models\WeddingBeneficiary::create([
...
public function edit($id){
    $this->Edit = true;
    $beneficiary = \App\Models\WeddingBeneficiary::findOrFail($id);
...
public function update()
{
    ...
    $beneficiary = \App\Models\WeddingBeneficiary::find($this->beneficiary_id);
    $beneficiary->update([
        'full_name' => $this->full_name,
        'phone' => $this->phone,
    ]);
...
public function delete($id){
    \App\Models\WeddingBeneficiary::find($id)->delete();
    $this->dispatch(event: 'toast', message: 'Beneficiary Deleted Successfully.');

}
    public function render()
    {
        $datas = \App\Models\WeddingBeneficiary::all();
        return view('livewire.admin.wedding-management.beneficiary', compact('datas'));
    }
}
