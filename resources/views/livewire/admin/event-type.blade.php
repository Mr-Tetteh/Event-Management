        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-5">
                <form class="bg-white rounded-xl shadow-lg" wire:submit.prevent="{{ $Edit ? 'update' : 'create' }}">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-t-xl p-6">
                        <h2 class="text-2xl font-bold text-white">Select Application Details</h2>
                    </div>

                    <!-- Form Content -->
                    <div class="p-8 space-y-6">
                        <h3 class="text-lg font-medium text-gray-900 border-b pb-2">Event Details</h3>
                        ...
                        <button
                            ...
                            {{ $Edit ? 'Update Application Details' : 'Upload Application Details' }}
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="lg:col-span-7">
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <div class="text-xl font-semibold text-gray-800 mb-6">Event Type</div>

                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Event Type</th>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 font-medium text-gray-900">{{ $data->event_name }}</td>
                                <td class="px-6 py-4">
