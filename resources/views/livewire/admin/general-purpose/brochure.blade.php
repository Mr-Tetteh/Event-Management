        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-5">
                <form class="bg-white rounded-xl shadow-lg" wire:submit.prevent="{{ $Edit ? 'update' : 'create' }}">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-t-xl p-6">
                        <h2 class="text-2xl font-bold text-white">Upload Brochure Details</h2>
                    </div>

                    <!-- Form Content -->
                    <div class="p-8 space-y-6">
                        <h3 class="text-lg font-medium text-gray-900 border-b pb-2">Brochure Details</h3>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full px-4 py-3 rounded-lg border border-gray-200 
                                       ...
                                       bg-gray-50 hover:bg-white transition text-black"
                                       placeholder="Name"
                                >                              
                            </input>
                            @error('name')
                        ...
                        <button
                            ...
                            {{ $Edit ? 'Update Brochure' : 'Upload Brochure' }}
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="lg:col-span-7">
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <div class="text-xl font-semibold text-gray-800 mb-6">Brochure </div>
                        ...
                        <table class="w-full">
                            ...
                            <tr>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Name</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Brochure</th>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900">{{ $data->file }}
                                      <iframe src="{{ Storage::url($data->brochure) }}"></iframe>

                                            <a href="{{Storage::url($data->brochure) }}"  class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
